...
import type { Procedure, ProcedureType, AltConstraint } from '../types/procedure'
...
/**
 * Per-procedure derived data (coords array, GS info, MAP index), memoized by
 * procedure identity — safe because `procedures` is replaced (new array/objects)
 * when the airport or AIRAC cycle changes.
 */
